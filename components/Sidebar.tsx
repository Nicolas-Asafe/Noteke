    ...
    <div className="bg-neutral-950  text-white w-64 h-screen border-r border-zinc-900 md:flex md:flex-col hidden">
      ...
      <section className="pt-8 p-3 flex flex-col border-t border-zinc-900">
        <div className="space-y-2 overflow-y-auto mb-4">
          <Link href={'/'} className="flex justify-between tr items-center p-1 px-2 bg-zinc-900 hover:bg-zinc-800 rounded-lg transition border border-neutral-800 hover:border-neutral-500 text-zinc-400">
            Go Home
            <Home size={30} className="p-1 rounded-mdtransition" />
          </Link>
          <Link href={'/plugins'} className="flex tr justify-between items-center p-1 px-2 bg-zinc-900 hover:bg-zinc-800 transition rounded-lg border border-neutral-800 hover:border-neutral-500 text-zinc-400">
            Plugins
            <Plug size={30} className="p-1 rounded-md  transition" />
          </Link>
          <Link href={'/docs'} className="flex tr justify-between items-center p-1 px-2 bg-zinc-900 hover:bg-zinc-800 transition rounded-lg border border-neutral-800 hover:border-neutral-500 text-zinc-400">
            Documents
          ...
          <ul className="space-y-2 p-3 pt-1 h-64 overflow-scroll">
            {allItems.map(item => (
              <li
                ...
                key={item.id}
                className="flex tr flex-row justify-between items-center transition shadow-md shadow-blackbg-neutral-950 hover:bg-zinc-800 rounded-lg hover:border-neutral-600 cursor-pointer border border-neutral-800"
              >
