  ...
  return (
    <div className="w-full min-h-screen flex flex-col animaMini overflow-y-auto h-[59dvh] md:h-[79dvh]">
      ...
      <div className="border-t p-5 border-neutral-900 overflow-auto md:mb-0 mb-20">
        ...
        <div className="mt-4">
        <p className="md:text-3xl text-xl font-bold w-auto mb-2 bg-neutral-950 border border-neutral-800 p-2 rounded-md text-center transition">Criando seus primeiros orgs</p>
         <p className="text-lg text-zinc-100">
            Quando você abrir o site você vai se deparar com a pagina de inicio que vai
         </p>
         <Image src="/imgsdocs/image1.png" className="mt-3 rounded-md border border-zinc-600" alt="" width={700} height={700} />
         <p className="text-lg text-zinc-100 mt-4 p-1 m-0 flex gap-2">
            Agora você vai clicar no botão <button className="bg-zinc-900 border border-neutral-800 p-1 rounded-md hover:border-neutral-500 hover:bg-zinc-800 transition flex items-center"><Plus size={17} /></button>
         </p>
         ...
         <p className="text-lg text-zinc-100 mt-3">
            Você pode clicar em um dos dois orgs e vai se redirecionar para a pagina de criação do org escolhido, vamos clicar no org NOTE
         </p>
         <Image src="/imgsdocs/image3.png" className="mt-3 rounded-md border border-zinc-600" alt="" width={700} height={700} />
        </div>
        ...
        <p className="text-lg font-medium text-zinc-100 mt-3">
            E pronto você criou sua primeira nota!
        </p>
      </div>
    </div>
  )
